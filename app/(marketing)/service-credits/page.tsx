...
export default function ServiceCreditsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-3">
          <div className="rounded-xl border bg-white/50 p-6 backdrop-blur-sm">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-green-500 to-emerald-600">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          <div className="flex gap-4 rounded-xl border bg-white/50 p-6 backdrop-blur-sm">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600 text-lg font-bold text-white">
              1
            </div>
            <div>
          ...
          <div className="flex gap-4 rounded-xl border bg-white/50 p-6 backdrop-blur-sm">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-pink-600 text-lg font-bold text-white">
              2
            </div>
            <div>
          ...
          <div className="flex gap-4 rounded-xl border bg-white/50 p-6 backdrop-blur-sm">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 to-red-600 text-lg font-bold text-white">
              3
            </div>
            <div>
      ...
      {/* Important Notes */}
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-3xl rounded-xl border bg-gradient-to-br from-amber-50 to-orange-50 p-8">
      ...
      {/* CTA */}
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-3xl rounded-2xl border bg-gradient-to-br from-blue-500 to-purple-600 p-12 text-center text-white">
