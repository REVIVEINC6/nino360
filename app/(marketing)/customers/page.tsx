              ...
              >
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                      ...
                      <ul className="space-y-2">
                        {study.results.map((result, i) => (
                          <li key={i} className="flex items-start gap-2">
                            <div className="mt-1 h-5 w-5 rounded-full bg-gradient-to-br from-green-500/20 to-emerald-500/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="p-4 rounded-lg bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-border/50">
