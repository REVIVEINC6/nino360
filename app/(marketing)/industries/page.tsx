          ...
          <div className="grid md:grid-cols-2 gap-8">
            {industries.map((industry, index) => {
              ...
              return (
                ...
                >
                  {/* Icon */}
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 mb-6 group-hover:scale-110 transition-transform">
