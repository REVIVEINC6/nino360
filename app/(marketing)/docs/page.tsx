        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-16">
            <Card className="p-6 backdrop-blur-xl bg-white/50 border-white/20 hover:shadow-xl transition-all cursor-pointer">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-blue-500 to-purple-500 flex items-center justify-center mb-4">
            ...
            <Card className="p-6 backdrop-blur-xl bg-white/50 border-white/20 hover:shadow-xl transition-all cursor-pointer">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-purple-500 to-pink-500 flex items-center justify-center mb-4">
            ...
            <Card className="p-6 backdrop-blur-xl bg-white/50 border-white/20 hover:shadow-xl transition-all cursor-pointer">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-pink-500 to-orange-500 flex items-center justify-center mb-4">
            ...
            <Card className="p-6 backdrop-blur-xl bg-white/50 border-white/20 hover:shadow-xl transition-all cursor-pointer">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-orange-500 to-red-500 flex items-center justify-center mb-4">
