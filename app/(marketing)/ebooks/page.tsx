    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="p-8 bg-white/60 backdrop-blur-sm border-white/20 mb-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="aspect-[3/4] bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-lg flex items-center justify-center">
                <BookOpen className="h-32 w-32 text-white" />
              </div>
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm mb-4">
                  Featured
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="aspect-[3/4] bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-lg flex items-center justify-center mb-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Card className="p-12 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 border-0 text-center">
