  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid gap-6 mb-12">
          ...
          {[
            ...
            <Card key={index} className="p-6 backdrop-blur-sm bg-white/80 hover:shadow-lg transition-all">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-lg bg-linear-to-br from-blue-100 to-purple-100">
        ...
        <Card className="p-8 backdrop-blur-sm bg-linear-to-br from-blue-50 to-purple-50 border-blue-200">
