    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="text-3xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
                100K+
              </div>
              <div className="text-gray-600">Total Downloads</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="text-3xl font-bold bg-linear-to-r from-pink-600 to-blue-600 bg-clip-text text-transparent mb-2">
                Monthly
              </div>
            ...
            {whitepapers.map((paper, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Button className="w-full bg-linear-to-r from-blue-600 to-purple-600 text-white hover:opacity-90">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-12 text-center text-white">
