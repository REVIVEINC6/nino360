...
export default function AffiliatePage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="relative overflow-hidden px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            <h1 className="text-balance bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-5xl font-bold tracking-tight text-transparent sm:text-6xl">
              Affiliate Program
            </h1>
            ...
            {[
              ...
              <Card key={stat.label} className="border-0 bg-white/60 p-6 backdrop-blur-sm">
                <div className="flex items-center gap-4">
                  <div className="rounded-lg bg-linear-to-br from-blue-500 to-purple-600 p-3">
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-3">
            {[
              ...
              <Card key={item.step} className="border-0 bg-white/60 p-8 backdrop-blur-sm">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-linear-to-br from-blue-500 to-purple-600 text-xl font-bold text-white">
                  {item.step}
                </div>
                <div className="mb-4 inline-flex rounded-lg bg-linear-to-br from-blue-100 to-purple-100 p-3">
            ...
            {[
              ...
              <Card
                ...
                className={`border-0 p-8 backdrop-blur-sm ${
                  tier.featured ? "bg-linear-to-br from-blue-500 to-purple-600 text-white" : "bg-white/60"
                }`}
              >
                ...
                <ul className="mt-6 space-y-3">
                  {tier.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      <CheckCircle2
                        className={`h-5 w-5 shrink-0 ${tier.featured ? "text-white" : "text-green-600"}`}
                      />
      ...
      <section className="px-6 py-16 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <Card className="border-0 bg-linear-to-br from-blue-500 to-purple-600 p-12 text-center backdrop-blur-sm">
