        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {solutions.map((solution) => (
              ...
              >
                <div className="mb-6 inline-flex rounded-xl bg-gradient-to-br from-primary/10 to-purple-500/10 p-4">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {benefits.map((benefit) => (
              <div key={benefit.title} className="rounded-2xl border bg-card/50 p-8 backdrop-blur-sm">
                <div className="mb-4 inline-flex rounded-xl bg-gradient-to-br from-primary/10 to-purple-500/10 p-3">
