    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl transition-all duration-300">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative h-64 md:h-auto bg-linear-to-br from-blue-100 to-indigo-100 flex items-center justify-center">
                  <TrendingUp className="h-24 w-24 text-blue-600/20" />
                </div>
                <div className="p-8 flex flex-col justify-center">
                  <Badge className="w-fit mb-4 bg-linear-to-r from-blue-600 to-indigo-600">Featured</Badge>
                  ...
                  <Button className="w-fit bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700">
                    Read Article
              ...
              {posts.map((post, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <Badge variant="outline" className="bg-linear-to-r from-blue-50 to-indigo-50">
                      {post.category}
                    </Badge>
          ...
          {/* Newsletter Signup */}
          <div className="mt-16 bg-linear-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 md:p-12 text-center text-white">
