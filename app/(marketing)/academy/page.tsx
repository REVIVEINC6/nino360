    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-12 h-12 rounded-full bg-linear-to-r from-blue-600 to-purple-600 flex items-center justify-center mb-4">
            ...
            {learningPaths.map((path, index) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 rounded-lg bg-linear-to-r from-blue-600 to-purple-600 flex items-center justify-center shrink-0">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {certifications.map((cert, index) => (
              <Card
                ...
                className="p-6 backdrop-blur-sm bg-white/50 border-white/20 hover:shadow-lg transition-shadow"
              >
                <div className="w-16 h-16 rounded-full bg-linear-to-r from-blue-600 to-purple-600 flex items-center justify-center mb-4 mx-auto">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 backdrop-blur-sm bg-linear-to-r from-blue-600 to-purple-600 border-0 text-white text-center">
