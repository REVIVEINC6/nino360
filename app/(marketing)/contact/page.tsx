      ...
      <header className="border-b border-white/20 backdrop-blur-xl bg-white/30">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/signup">
              <Button size="sm" className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white">
                Get Started
              </Button>
            </Link>
          </nav>
            ...
            <div className="space-y-8">
              <div className="backdrop-blur-xl bg-white/40 rounded-2xl p-8 border border-white/20 shadow-xl">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-gradient-to-br from-pink-500/20 to-blue-500/20">
