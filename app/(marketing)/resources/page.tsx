...
export default function ResourcesPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative border-b bg-linear-to-b from-background to-muted/20 py-20">
              ...
              return (
                <div key={category.title}>
                  <div className="mb-8 flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-sm">
                    ...
                    {category.items.map((item) => (
                      ...
                      >
                        <div className="mb-4 flex items-start justify-between">
                          ...
                          <span className="rounded-full bg-linear-to-r from-blue-500/10 to-cyan-500/10 px-3 py-1 text-xs font-medium text-blue-600">
                            {item.format}
                          </span>
                        </div>
