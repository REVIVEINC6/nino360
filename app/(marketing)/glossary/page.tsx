    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
          ...
          {Object.entries(groupedTerms).map(([letter, letterTerms]) => (
            <div key={letter} id={letter} className="mb-12 scroll-mt-24">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-blue-600 to-purple-600 flex items-center justify-center">
              ...
              <div className="space-y-6">
                {letterTerms.map((term, index) => (
                  ...
                  >
                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:bg-linear-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text group-hover:text-transparent transition-all">
                      {term.term}
                    </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 p-12 text-center">
