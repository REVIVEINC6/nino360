  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-primary/20 to-purple-500/20">
      ...
      <section className="border-t px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl border bg-gradient-to-br from-primary/5 via-purple-500/5 to-pink-500/5 p-12 text-center backdrop-blur-sm">
