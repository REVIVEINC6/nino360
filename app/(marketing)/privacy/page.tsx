        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-8 rounded-2xl bg-white/60 backdrop-blur-sm border border-purple-200">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <Link
                href="/terms"
                className="flex items-center gap-3 p-4 rounded-xl bg-linear-to-br from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-all group"
              >
