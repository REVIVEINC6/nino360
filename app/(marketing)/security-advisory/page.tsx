  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200 mb-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={advisory.id}
                className="p-6 rounded-xl bg-linear-to-br from-gray-50 to-gray-100 border border-gray-200"
              >
        ...
        {/* Bug Bounty Program */}
        <div className="bg-linear-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white text-center">
