    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="backdrop-blur-sm bg-white/70 rounded-2xl border border-white/20 shadow-xl p-8 mb-8">
            <div className="flex items-start justify-between mb-6">
              <div>
                <Badge className="mb-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white border-0">
                  Latest Release
                </Badge>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-gradient-to-r from-orange-600 to-red-600 text-white border-0">Coming Soon</Badge>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="backdrop-blur-sm bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 sm:p-12 text-center text-white">
