      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <Card className="p-8 backdrop-blur-sm bg-white/80 border-white/20 shadow-xl">
              ...
              <form className="space-y-6">
                ...
                <Button className="w-full bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-6 text-lg">
                  Start Free Trial
                </Button>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 backdrop-blur-sm bg-white/80 border-white/20 shadow-xl">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-lg bg-linear-to-br from-pink-500 to-blue-500">
              ...
              <Card className="p-6 backdrop-blur-sm bg-white/80 border-white/20 shadow-xl">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-lg bg-linear-to-br from-blue-500 to-pink-500">
