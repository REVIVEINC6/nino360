    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
            ...
            {[
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="h-12 w-12 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
          ...
          {/* Popular Categories */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-8 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              Browse by Category
            </h2>
              ...
              {[
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="h-12 w-12 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
          ...
          {/* Contact Support */}
          <Card className="p-8 backdrop-blur-sm bg-linear-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 border-white/20 text-center">
            <h2 className="text-2xl font-bold mb-4 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
