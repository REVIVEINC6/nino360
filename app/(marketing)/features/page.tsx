    ...
    <div className="min-h-screen bg-linear-to-br from-background via-background to-muted/20">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-linear-to-r from-primary via-purple-500 to-pink-500 bg-clip-text text-transparent">
            ...
            {coreModules.map((module) => (
              ...
              >
                ...
                <div className="relative">
                  <div className="w-12 h-12 rounded-lg bg-linear-to-br from-primary to-purple-500 flex items-center justify-center mb-4">
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-primary/10 to-purple-500/10 border border-primary/20 mb-4">
            ...
            {aiFeatures.map((feature) => (
              <div key={feature.title} className="bg-card/50 backdrop-blur-sm border rounded-lg p-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-linear-to-br from-primary to-purple-500 flex items-center justify-center shrink-0">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {securityFeatures.map((feature) => (
              <div key={feature.title} className="bg-card/50 backdrop-blur-sm border rounded-lg p-6 text-center">
                <div className="w-12 h-12 rounded-lg bg-linear-to-br from-green-500 to-blue-500 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-linear-to-br from-primary/10 via-purple-500/10 to-pink-500/10 backdrop-blur-sm border rounded-2xl p-12">
