    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-6">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl mb-4">
                  {process.step}
                </div>
          ...
          <div className="backdrop-blur-sm bg-white/70 rounded-2xl p-8 border border-white/20 shadow-lg">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                <div
                  key={system}
                  className="p-4 rounded-xl bg-gradient-to-br from-blue-50 to-purple-50 border border-purple-100"
                >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="backdrop-blur-sm bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-center text-white shadow-2xl">
