...
const typeConfig = {
  feature: { label: "New", color: "bg-linear-to-r from-blue-500/20 to-cyan-500/20 text-blue-400 border-blue-500/30" },
  improvement: {
    label: "Improved",
    color: "bg-linear-to-r from-purple-500/20 to-pink-500/20 text-purple-400 border-purple-500/30",
  },
  fix: {
    label: "Fixed",
    color: "bg-linear-to-r from-green-500/20 to-emerald-500/20 text-green-400 border-green-500/30",
  },
}
...
export default function ChangelogPage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            {releases.map((release) => (
              <div key={release.version} className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Badge
                    variant="outline"
                    className="bg-linear-to-r from-blue-500/20 to-cyan-500/20 text-blue-400 border-blue-500/30"
                  >
                    Latest
                  </Badge>
                </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="backdrop-blur-xl bg-linear-to-br from-blue-500/10 to-cyan-500/10 border border-white/10 rounded-2xl p-12 text-center">
