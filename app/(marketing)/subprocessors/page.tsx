  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div className="backdrop-blur-sm bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-6 shadow-lg border border-white/20 mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="backdrop-blur-sm bg-white/70 rounded-2xl p-6 shadow-lg border border-white/20">
            <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
              <div className="p-2 bg-gradient-to-br from-blue-500 to-pink-600 rounded-lg text-white">
                <Building2 className="w-5 h-5" />
              </div>
              Payment Processing
            </h3>
        ...
        {/* Contact */}
        <div className="text-center mt-12 p-8 backdrop-blur-sm bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl border border-white/20">
