    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
            ...
            {["All Videos", "Product Demos", "Tutorials", "Webinars", "Customer Stories", "Expert Talks"].map(
              (category) => (
                <Button
                  ...
                  className={category === "All Videos" ? "bg-linear-to-r from-blue-600 to-purple-600" : ""}
                >
                  {category}
                </Button>
              ),
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="overflow-hidden backdrop-blur-sm bg-white/80 border-white/20 shadow-xl">
            <div className="grid md:grid-cols-2 gap-8 p-8">
              <div className="relative aspect-video bg-linear-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center group cursor-pointer">
              ...
              <div className="flex flex-col justify-center">
                <Badge className="w-fit mb-4 bg-linear-to-r from-blue-600 to-purple-600">Product Demo</Badge>
                ...
                <Button className="w-fit bg-linear-to-r from-blue-600 to-purple-600">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {videos.map((video, index) => (
              ...
              >
                <div className="relative aspect-video bg-linear-to-br from-blue-100 to-purple-100 flex items-center justify-center group cursor-pointer">
                ...
                <div className="p-6">
                  <Badge className="mb-3 bg-linear-to-r from-blue-600 to-purple-600">{video.category}</Badge>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Card className="backdrop-blur-sm bg-linear-to-br from-blue-600/90 to-purple-600/90 border-white/20 shadow-2xl">
