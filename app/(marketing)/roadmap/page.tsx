            ...
            {roadmapItems.map((quarter, idx) => (
              <div key={quarter.quarter} className="relative">
                ...
                {idx !== roadmapItems.length - 1 && (
                  <div className="absolute left-8 top-24 bottom-0 w-0.5 bg-linear-to-b from-blue-200 via-purple-200 to-pink-200 hidden lg:block" />
                )}
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-4">
                            <div className="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 bg-white/80 backdrop-blur-sm border-gray-200 text-center">
            <div className="w-16 h-16 rounded-full bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-6">
              <Lightbulb className="w-8 h-8 text-white" />
            </div>
            <h2 className="text-3xl font-bold mb-4 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
            ...
            {[
              ...
              return (
                <div key={idx} className="text-center">
                  <div className="w-12 h-12 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-4">
                    <Icon className="w-6 h-6 text-white" />
                  </div>
                  <div className="text-3xl font-bold bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
                    {stat.value}
                  </div>
