    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 border shadow-lg mb-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-purple-500 to-pink-500 flex items-center justify-center">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 border shadow-lg mb-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-pink-500 to-orange-500 flex items-center justify-center">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 border shadow-lg mb-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-12 w-12 rounded-lg bg-linear-to-br from-orange-500 to-red-500 flex items-center justify-center">
          ...
          {/* Contact */}
          <div className="bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 rounded-xl p-8 text-white text-center">
