    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="border-b border-white/20 bg-white/40 backdrop-blur-xl">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl font-bold text-balance bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-4">
            Sitemap
          </h1>
      ...
      <div className="container mx-auto px-4 py-16">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center">
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-12 text-center">
