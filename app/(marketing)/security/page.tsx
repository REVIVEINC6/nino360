        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-xl border bg-linear-to-br from-background to-muted/20 p-6 backdrop-blur-sm transition-all hover:shadow-lg"
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-linear-to-br from-primary/20 to-primary/5">
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="rounded-xl border bg-linear-to-br from-background to-muted/20 p-8 backdrop-blur-sm">
