...
export default function CompliancePage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className={`inline-flex p-3 rounded-xl bg-linear-to-br ${cert.color} mb-4`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="inline-flex p-3 rounded-xl bg-linear-to-br from-blue-500 to-purple-600 mb-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-linear-to-br from-blue-500 via-purple-600 to-pink-600 rounded-2xl p-8 text-white text-center">
