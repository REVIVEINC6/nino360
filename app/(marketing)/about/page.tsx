    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
          ...
          <div className="backdrop-blur-xl bg-white/70 rounded-3xl p-12 border border-white/20 shadow-xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="backdrop-blur-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl p-6 border border-white/20">
                  <Target className="w-12 h-12 text-blue-600 mb-4" />
                  <h3 className="text-2xl font-bold mb-2">10K+</h3>
                  <p className="text-gray-600">Active Users</p>
                </div>
                <div className="backdrop-blur-xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl p-6 border border-white/20">
                  <Users className="w-12 h-12 text-purple-600 mb-4" />
                  <h3 className="text-2xl font-bold mb-2">500+</h3>
                  <p className="text-gray-600">Companies</p>
                </div>
                <div className="backdrop-blur-xl bg-gradient-to-br from-pink-500/10 to-blue-500/10 rounded-2xl p-6 border border-white/20">
                  <Award className="w-12 h-12 text-pink-600 mb-4" />
                  <h3 className="text-2xl font-bold mb-2">98%</h3>
                  <p className="text-gray-600">Satisfaction</p>
                </div>
                <div className="backdrop-blur-xl bg-gradient-to-br from-blue-500/10 to-pink-500/10 rounded-2xl p-6 border border-white/20">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="backdrop-blur-xl bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-3xl p-12 border border-white/20 shadow-xl">
