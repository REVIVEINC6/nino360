    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-background via-background to-muted/20 p-4">
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="relative">
          <h1 className="text-[150px] md:text-[200px] font-bold bg-linear-to-br from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent leading-none">
            404
          </h1>
          <div className="absolute inset-0 bg-linear-to-br from-primary/20 to-transparent blur-3xl -z-10" />
        </div>
