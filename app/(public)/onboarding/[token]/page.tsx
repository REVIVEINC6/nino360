    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full bg-linear-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 px-4 py-2">
        ...
        {pendingTasks.length === 0 && completedTasks.length > 0 && (
          <Card className="border-green-500/30 bg-linear-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm">
