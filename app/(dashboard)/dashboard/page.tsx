...
import { MasterDashboardSidebar } from "@/components/dashboard/master-dashboard-sidebar"
import { DashboardRealtimeProvider } from "@/components/dashboard/realtime/dashboard-realtime-context"
import { LiveKpiStrip } from "@/components/dashboard/realtime/live-kpi-strip"
import { LiveActivityTicker } from "@/components/dashboard/realtime/live-activity-ticker"
      ...
      <div className="relative z-10 space-y-6">
        {hasCopilotAccess && (
          <div className="glass-card rounded-xl p-1 shadow-lg">
            <CopilotRibbon className="bg-linear-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10" />
          </div>
        )}
        ...
        <div className="glass-card rounded-xl p-6 text-center shadow-lg">
          <p className="text-sm font-medium bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
    ...
    <TwoPane right={<MasterDashboardSidebar />}> 
      <DashboardRealtimeProvider>
        <div className="p-6 space-y-6">
          {/* Live strip of newest AI/audit/RPA events */}
          <LiveKpiStrip />
          {/* Main content */}
