...
export default async function TenantDashboardPage({
  ...
  context.features.copilot ? getAiDigest() : Promise.resolve(null),
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 p-4 md:p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-4 lg:grid-cols-7">
          <div className="lg:col-span-4">
            {/* Use client wrapper to enable realtime updates for module usage and audit timeline */}
            <TenantDashboardClient
              initialModules={moduleUsage}
              initialAudit={auditEntries}
              initialDigest={aiInitial}
              dateRange={dateRange}
            />
          </div>
