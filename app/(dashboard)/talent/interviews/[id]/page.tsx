...
export default async function InterviewWorkspacePage({ params }: InterviewWorkspacePageProps) {
  ...
  const { interview, candidate, application, requisition, panel, feedback } = result.data
  ...
  const myFeedback = feedback.find((f) => f.is_current_user)
            ...
            <Card className="border-slate-800 bg-slate-900/50 backdrop-blur-sm">
              ...
              <CardContent>
                <ScorecardForm
                  ...
                  scorecardId={interview.scorecard_id}
        ...
        {feedback.length > 0 && (
          <Card className="border-slate-800 bg-slate-900/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <p className="text-sm text-slate-400">
                {feedback.filter((f) => f.feedback_submitted).length} of {panel.length} panel members have submitted
                feedback
              </p>
            </CardHeader>
            <CardContent>
