                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <AIInsightCard title={skill.name} description={skill.aiInsight} />
                        </div>
                      </div>
                    </motion.div>
                  ))}
            ...
            <TabsContent value="recommendations" className="space-y-4">
              {aiRecommendations.map((rec, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                >
                  <AIInsightCard title={rec.title} description={rec.description} variant={rec.type === "hiring" ? "warning" : "info"} />
                </motion.div>
              ))}
            </TabsContent>
