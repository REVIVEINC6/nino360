-- ESG OS Platform - Complete Database Schema (Fixed for existing tables)
...
INSERT INTO tenants (name, slug, domain, subscription_plan, max_users, status) VALUES
('TechCorp Solutions', 'techcorp', 'techcorp.example.com', 'enterprise', 100, 'active'),
('StartupXYZ', 'startupxyz', 'startup.example.com', 'professional', 50, 'active'),
('Global Enterprises', 'global-ent', 'global.example.com', 'enterprise', 200, 'active');
