...
CREATE TABLE IF NOT EXISTS onboarding_templates (
  ...
  CONSTRAINT fk_onboarding_templates_tenant FOREIGN KEY (tenant_id) REFERENCES app.tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS onboarding_workflows (
  ...
  -- Assignments
  buddy_id UUID REFERENCES app.users(id),
  manager_id UUID REFERENCES app.users(id),
  hr_contact_id UUID REFERENCES app.users(id),
  ...
  CONSTRAINT fk_onboarding_workflows_tenant FOREIGN KEY (tenant_id) REFERENCES app.tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS onboarding_tasks (
  ...
  CONSTRAINT fk_onboarding_tasks_tenant FOREIGN KEY (tenant_id) REFERENCES app.tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS onboarding_documents (
  ...
  CONSTRAINT fk_onboarding_documents_tenant FOREIGN KEY (tenant_id) REFERENCES app.tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS onboarding_checklists (
  ...
  CONSTRAINT fk_onboarding_checklists_tenant FOREIGN KEY (tenant_id) REFERENCES app.tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS onboarding_feedback (
  ...
  CONSTRAINT fk_onboarding_feedback_tenant FOREIGN KEY (tenant_id) REFERENCES app.tenants(id) ON DELETE CASCADE
);
...
((SELECT id FROM app.tenants LIMIT 1), 'Standard Employee Onboarding', 'Standard 90-day onboarding for new employees', 90,
...
((SELECT id FROM app.tenants LIMIT 1), (SELECT id FROM candidates LIMIT 1), 'John Doe Onboarding', CURRENT_DATE, 'in_progress');
