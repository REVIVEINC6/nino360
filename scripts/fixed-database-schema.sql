...
-- Sample AI insights
INSERT INTO ai_insights (tenant_id, title, description, type, priority, confidence, impact, category, status, metrics, recommendations) VALUES
((SELECT id FROM tenants WHERE slug = 'demo-corp'), 
 'Revenue Growth Opportunity', 
 'Analysis shows potential 15% revenue increase through customer retention optimization',
 ...
 'new',
 '{"current_retention": 78, "target_retention": 85, "potential_revenue_increase": 15}',
 '["Implement customer success program", "Enhance onboarding process", "Create loyalty rewards system"]');

-- Sample notifications
INSERT INTO notifications (tenant_id, auth_user_id, title, message, type, priority, category, actionable, action_url, action_label) VALUES
((SELECT id FROM tenants WHERE slug = 'demo-corp'),
 (SELECT id FROM auth.users LIMIT 1),
 'System Update Available',
 'A new system update is available with enhanced security features and performance improvements.',
 'info',
 'medium',
 'System',
 true,
...
-- Sample workflows
INSERT INTO workflows (tenant_id, name, description, category, status, priority, progress, configuration) VALUES
((SELECT id FROM tenants WHERE slug = 'demo-corp'),
 'Employee Onboarding',
 'Complete onboarding process for new employees',
 'HR',
 'active',
 'high',
 65,
 '{"auto_assign": true, "notification_enabled": true, "deadline_days": 7}');
...
LEFT JOIN user_profiles up ON w.owner_id = up.auth_user_id
GROUP BY w.id, up.first_name, up.last_name;
