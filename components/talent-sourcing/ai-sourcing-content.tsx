      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <Card className="p-6 bg-white/70 backdrop-blur-md border-white/20 shadow-xl">
          ...
          {insights && insights.length > 0 && (
            <div className="mt-4 p-4 bg-linear-to-r from-purple-100/50 to-pink-100/50 rounded-lg border border-purple-200/50">
      ...
      <Tabs defaultValue="candidates" className="space-y-4">
                ...
                >
                  <Card className="p-4 bg-white/70 backdrop-blur-md border-white/20 hover:shadow-xl transition-all hover:scale-105">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" className="flex-1 bg-linear-to-r from-blue-600 to-purple-600">
                        Match to Job
                      </Button>
                    </div>
                  </Card>
        ...
        <TabsContent value="matches">
          <Card className="p-12 text-center bg-white/70 backdrop-blur-md border-white/20">
            ...
            <Button className="bg-linear-to-r from-blue-600 to-purple-600">Run AI Matching</Button>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="campaigns">
          <Card className="p-12 text-center bg-white/70 backdrop-blur-md border-white/20">
            ...
            <Button className="bg-linear-to-r from-blue-600 to-purple-600">Create Campaign</Button>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="audit">
          <Card className="p-12 text-center bg-white/70 backdrop-blur-md border-white/20">
            ...
            <Button className="bg-linear-to-r from-green-600 to-blue-600">View Audit Trail</Button>
          </Card>
        </TabsContent>
      </Tabs>
    </div>
