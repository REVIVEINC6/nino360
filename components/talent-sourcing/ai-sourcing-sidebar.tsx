    ...
    <div className="w-80 border-l bg-white/50 backdrop-blur-md p-6 space-y-6 overflow-y-auto">
      ...
      >
        ...
        <div className="space-y-3">
          {insights.slice(0, 3).map((insight, index) => (
            <Card
              key={insight.id}
              className="p-4 bg-gradient-to-br from-purple-50/50 to-pink-50/50 border-purple-200/50"
            >
      ...
      >
        ...
        <div className="space-y-2">
          <Card className="p-3 bg-gradient-to-r from-blue-50/50 to-purple-50/50 border-blue-200/50">
            <div className="flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-purple-600" />
              <span className="text-sm font-medium">Generative AI</span>
            </div>
          </Card>
          <Card className="p-3 bg-gradient-to-r from-purple-50/50 to-pink-50/50 border-purple-200/50">
            <div className="flex items-center gap-2">
              <Zap className="h-4 w-4 text-pink-600" />
              <span className="text-sm font-medium">Machine Learning</span>
            </div>
          </Card>
          <Card className="p-3 bg-gradient-to-r from-green-50/50 to-blue-50/50 border-green-200/50">
            <div className="flex items-center gap-2">
              <Shield className="h-4 w-4 text-green-600" />
              <span className="text-sm font-medium">Blockchain</span>
            </div>
          </Card>
          <Card className="p-3 bg-gradient-to-r from-blue-50/50 to-cyan-50/50 border-blue-200/50">
            <div className="flex items-center gap-2">
