...
import { savePolicies } from "@/app/(app)/tenant/security/actions"
...
export function PolicyPanel({ context }: PolicyPanelProps) {
  ...
  const handleSave = async () => {
    ...
    const result = await savePolicies({
      ...
      password_require_symbols: passwordSymbols,
      password_require_numbers: passwordNumbers,
      password_require_cases: passwordCases,
    })
