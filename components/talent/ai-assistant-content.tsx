...
export function AIAssistantContent() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-300px)] rounded-lg border border-border bg-linear-to-br from-white/50 to-blue-50/30 backdrop-blur-sm">
      {/* Messages Area */}
          ...
          {messages.map((message, index) => (
            ...
            >
              {message.role === "assistant" && (
                <div className="shrink-0 w-8 h-8 rounded-full bg-linear-to-br from-blue-500 to-purple-500 flex items-center justify-center">
              ...
              {message.role === "user" && (
                <div className="shrink-0 w-8 h-8 rounded-full bg-linear-to-br from-pink-500 to-purple-500 flex items-center justify-center">
