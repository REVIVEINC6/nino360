      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="glass-card p-6 rounded-2xl border border-white/20 shadow-xl">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-xl">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="glass-card border-white/20 shadow-lg hover:shadow-xl transition-all">
            ...
            <CardContent>
              ...
              <div className="mt-3 h-1 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full w-[85%] bg-linear-to-r from-blue-500 to-blue-400 rounded-full" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card border-white/20 shadow-lg hover:shadow-xl transition-all">
            ...
            <CardContent>
              ...
              <div className="mt-3 h-1 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full w-[86%] bg-linear-to-r from-purple-500 to-purple-400 rounded-full" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card border-white/20 shadow-lg hover:shadow-xl transition-all">
            ...
            <CardContent>
              <div className="text-3xl font-bold bg-linear-to-r from-green-600 to-green-400 bg-clip-text text-transparent">
                375%
              </div>
              <div className="flex items-center gap-2 mt-2">
                <div className="flex items-center gap-1 text-green-600 text-sm">
              ...
              <div className="mt-3 h-1 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full w-[92%] bg-linear-to-r from-green-500 to-green-400 rounded-full" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card border-white/20 shadow-lg hover:shadow-xl transition-all">
            ...
            <CardContent>
              <div className="text-3xl font-bold bg-linear-to-r from-orange-600 to-orange-400 bg-clip-text text-transparent">
                85%
              </div>
              <div className="flex items-center gap-2 mt-2">
                <div className="flex items-center gap-1 text-green-600 text-sm">
              ...
              <div className="mt-3 h-1 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full w-[85%] bg-linear-to-r from-orange-500 to-orange-400 rounded-full" />
              </div>
            </CardContent>
          </Card>
        </div>
