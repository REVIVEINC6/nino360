    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {stats.map((stat, index) => (
          ...
          >
            <Card className="relative overflow-hidden border-white/20 bg-linear-to-br from-white/40 to-white/10 backdrop-blur-xl p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">{stat.label}</p>
                  <p className="text-2xl font-bold mt-1">{stat.value}</p>
                </div>
                <div className="h-12 w-12 rounded-xl bg-linear-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
      ...
      {/* Chat Interface */}
      <Card className="relative overflow-hidden border-white/20 bg-linear-to-br from-white/40 to-white/10 backdrop-blur-xl">
