              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <Card
                      key={match.candidate}
                      className="p-6 border-0 bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm hover:shadow-xl transition-all duration-300"
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right">
                          <Badge
                            variant="default"
                            className="bg-gradient-to-r from-green-500 to-emerald-500 text-white mb-2"
                          >
                            {match.match}% Match
                          </Badge>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <Card key={gap.skill} className="p-4 border-0 bg-gradient-to-br from-white/80 to-white/60">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <Card
                      ...
                      className="p-4 border-0 bg-gradient-to-br from-white/80 to-white/60"
                    >
