      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <div className="relative bg-linear-to-r from-blue-500 to-purple-500 p-3 rounded-full">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-linear-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
