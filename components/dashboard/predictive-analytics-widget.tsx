      ...
      <CardContent>
        {loading && (
          <div className="space-y-4">
            <div className="h-48 rounded-lg bg-gradient-to-r from-gray-200/50 to-gray-100/50 animate-pulse" />
            <div className="grid grid-cols-3 gap-3">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-20 rounded-lg bg-gradient-to-r from-gray-200/50 to-gray-100/50 animate-pulse"
                />
              ))}
            </div>
          </div>
        ...
        {!loading && !error && predictions.length > 0 && (
          <div className="space-y-4">
            {/* Chart */}
            <div className="h-48 rounded-lg backdrop-blur-sm bg-gradient-to-br from-white/80 to-white/40 border border-white/30 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {predictions.slice(0, 3).map((pred) => (
                <div
                  key={pred.id}
                  className="p-4 rounded-lg backdrop-blur-sm bg-gradient-to-br from-white/80 to-white/40 border border-white/30"
                >
