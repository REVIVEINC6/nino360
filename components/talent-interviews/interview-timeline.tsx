    ...
    <Card className="border-slate-800 bg-slate-900/50 backdrop-blur-sm">
      ...
      <CardContent>
        <div className="relative space-y-6">
          {/* Timeline line */}
          <div className="absolute left-6 top-0 h-full w-px bg-linear-to-b from-blue-500 via-purple-500 to-transparent" />
                  ...
                  {event.user_name && (
                    <div className="flex items-center gap-2">
                      <Avatar className="h-6 w-6">
                        ...
                        <AvatarFallback className="bg-linear-to-br from-blue-500 to-purple-500 text-xs text-white">
                          {event.user_name
                            .split(" ")
                            .map((n) => n[0])
                            .join("")}
