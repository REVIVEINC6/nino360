...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-linear-to-b from-white via-slate-50 to-white">
      <SceneParticles />
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <span className="text-sm font-medium bg-linear-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">
          ...
          >
            ...
            <span className="bg-linear-to-r from-[#4F46E5] via-[#8B5CF6] to-[#A855F7] bg-clip-text text-transparent glow-sm">
              Intelligence
            </span>{" "}
            with Nino360
          </motion.h1>
          ...
          >
            <Link href="#modules">
              <Button
                size="lg"
                className="bg-linear-to-r from-[#4F46E5] via-[#8B5CF6] to-[#A855F7] hover:opacity-90 transition-opacity text-lg px-8 py-6 gap-2 neon-glow-hover"
              >
                🚀 Explore Platform
