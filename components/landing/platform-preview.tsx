      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {mockups.map((mockup, index) => (
            ...
            >
              <div className="p-6 rounded-2xl bg-linear-to-br from-white/10 to-white/5 border border-white/10 backdrop-blur-sm overflow-hidden">
                <div className="mb-4">
                ...
                <div className="aspect-video rounded-lg bg-linear-to-br from-white/5 to-white/0 border border-white/10 flex items-center justify-center relative overflow-hidden">
                  <div
        ...
        >
          {[
            ...
            <div key={i} className="space-y-1">
              <div className="text-3xl font-bold bg-linear-to-r from-[#4F46E5] via-[#8B5CF6] to-[#A855F7] bg-clip-text text-transparent">
                {stat.value}
              </div>
