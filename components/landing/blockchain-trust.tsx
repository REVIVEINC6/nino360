...
export function BlockchainTrust() {
  ...
  return (
    <section id="trust" className="relative py-32 bg-gradient-to-b from-black via-[#0a0015] to-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-12">
          {[
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 backdrop-blur-sm text-center"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="max-w-2xl mx-auto p-8 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 backdrop-blur-sm"
        >
          <h3 className="text-xl font-semibold mb-4 text-center">Verify Event Hash</h3>
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#F81CE5] to-[#8B5CF6] hover:opacity-90 transition-opacity"
            >
              Verify
            </Button>
          </div>
