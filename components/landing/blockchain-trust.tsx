...
export function BlockchainTrust() {
  ...
  return (
    <section id="trust" className="relative py-32 bg-linear-to-b from-white via-slate-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-12">
          {[
            ...
            >
              <div className="h-16 w-16 rounded-full bg-linear-to-br from-[#F81CE5]/20 to-[#F81CE5]/10 flex items-center justify-center mx-auto mb-4">
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="bg-linear-to-r from-[#F81CE5] to-[#8B5CF6] hover:opacity-90 transition-opacity text-white"
            >
              Verify
            </Button>
          </div>
