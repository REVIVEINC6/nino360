...
export function CTASection() {
  ...
  return (
    <section
      id="cta-section"
      className="relative py-32 bg-linear-to-b from-white via-slate-50 to-white overflow-hidden"
    >
      <motion.div
          ...
          <div className="max-w-2xl mx-auto p-8 rounded-2xl backdrop-blur-xl bg-white/70 border border-slate-200/50 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <Button
                ...
                className="flex-1 bg-linear-to-r from-[#4F46E5] via-[#8B5CF6] to-[#A855F7] hover:opacity-90 transition-opacity text-lg gap-2 text-white"
              >
