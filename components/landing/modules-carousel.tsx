...
export function ModulesCarousel() {
  ...
  return (
    <section id="modules" className="relative py-32 bg-linear-to-b from-black via-[#0a0015] to-black">
            ...
            <motion.div
              ...
              className={`p-6 rounded-2xl cursor-pointer transition-all duration-300 ${
                selectedModule === index
                  ? "bg-linear-to-br from-white/10 to-white/5 border-2 scale-105"
                  : "bg-linear-to-br from-white/5 to-white/0 border border-white/10 hover:border-white/30"
              }`}
              style={{
