...
export function CopilotDemo() {
  ...
  return (
    <section id="copilot" className="relative py-32 bg-linear-to-b from-white via-slate-50 to-white">
            ...
            <div className="p-6 rounded-2xl backdrop-blur-xl bg-white/70 border border-slate-200/50 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-linear-to-r from-[#4F46E5] via-[#8B5CF6] to-[#A855F7] hover:opacity-90 transition-opacity text-white"
                >
