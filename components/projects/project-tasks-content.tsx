      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={view === "kanban" ? "bg-linear-to-r from-blue-600 to-purple-600" : ""}
          >
          ...
          <Button
            ...
            className={view === "list" ? "bg-linear-to-r from-blue-600 to-purple-600" : ""}
          >
          ...
          <Button
            ...
            className={view === "gantt" ? "bg-linear-to-r from-blue-600 to-purple-600" : ""}
          >
