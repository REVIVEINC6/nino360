  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="p-4 bg-linear-to-br from-purple-50 to-pink-50 border-purple-200">
          <div className="flex items-center justify-between">
            <div>
        ...
        <Card className="p-4 bg-linear-to-br from-pink-50 to-blue-50 border-pink-200">
          <div className="flex items-center justify-between">
            <div>
          ...
          <Card key={file.id} className="p-4 hover:shadow-lg transition-shadow">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-linear-to-br from-blue-50 to-purple-50">
