  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="p-6 bg-white/40 backdrop-blur-xl border-white/20">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-linear-to-br from-yellow-500/20 to-orange-500/20">
        ...
        <Card className="p-6 bg-white/40 backdrop-blur-xl border-white/20">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-linear-to-br from-red-500/20 to-pink-500/20">
