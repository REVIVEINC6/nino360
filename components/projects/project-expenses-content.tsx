        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <Card className="glass-panel p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 rounded-xl bg-linear-to-br from-yellow-500/10 to-orange-500/10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <Card className="glass-panel p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 rounded-xl bg-linear-to-br from-green-500/10 to-emerald-500/10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <Card className="glass-panel p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 rounded-xl bg-linear-to-br from-purple-500/10 to-pink-500/10">
