  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="glass-card p-6 rounded-xl border-0 hover:scale-105 transition-transform bg-linear-to-br from-blue-500 to-purple-600">
          <div className="flex items-center justify-between mb-2">
        ...
        <TabsContent value="new-hires" className="space-y-4">
          <Card className="glass-card p-6 rounded-xl border-0">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button className="bg-linear-to-r from-blue-600 to-purple-600 text-white border-0">
              ...
              {newHires.map((hire: any) => (
                <Card key={hire.id} className="p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button
                      size="sm"
                      className="flex-1 bg-linear-to-r from-blue-600 to-purple-600 text-white border-0"
                    >
