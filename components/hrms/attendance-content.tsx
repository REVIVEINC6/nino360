              ...
              <CardContent>
                <div className="space-y-3">
                  {data.checkins?.slice(0, 5).map((checkin: any) => (
                    <div
                      key={checkin.id}
                      className="flex items-center justify-between p-3 rounded-lg bg-linear-to-r from-blue-50 to-purple-50 border border-blue-100"
                    >
              ...
              <CardContent>
                <div className="space-y-3">
                  {data.leaveRequests?.slice(0, 10).map((request: any) => (
                    <div
                      key={request.id}
                      className="flex items-center justify-between p-4 rounded-lg bg-linear-to-r from-blue-50 to-purple-50 border border-blue-100"
                    >
                      <div>
                        <p className="font-medium">
