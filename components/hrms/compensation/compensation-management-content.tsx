    ...
    <div className="space-y-6">
        ...
        <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mt-2">
                {stats.activeCycles}
              </p>
        ...
        <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold bg-linear-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mt-2">
                {stats.pendingReviews}
              </p>
              <p className="text-xs text-gray-500 mt-1">Awaiting approval</p>
            </div>
            <div className="h-12 w-12 rounded-full bg-linear-to-br from-orange-500 to-red-500 flex items-center justify-center">
        ...
        <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold bg-linear-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mt-2">
                {stats.avgIncrease}%
              </p>
              <p className="text-xs text-gray-500 mt-1">Merit adjustments</p>
            </div>
            <div className="h-12 w-12 rounded-full bg-linear-to-br from-green-500 to-emerald-500 flex items-center justify-center">
              <TrendingUp className="h-6 w-6 text-white" />
            </div>
          </div>
        </Card>
        ...
        <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mt-2">
                {stats.budgetUsed}%
              </p>
      ...
      <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl">
        <div className="flex items-start gap-4">
          <div className="h-10 w-10 rounded-full bg-linear-to-br from-blue-500 to-purple-500 flex items-center justify-center shrink-0">
        ...
        <TabsContent value="bands" className="space-y-4">
          <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button className="bg-linear-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600">
                Add Band
              </Button>
            </div>
              ...
              {cycles.map((cycle) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    {cycle.status === "OPEN" && (
                      <Button size="sm" className="bg-linear-to-r from-blue-500 to-purple-500 text-white">
                        Review Proposals
                      </Button>
                    )}
                  </div>
          ...
          <Card className="glass-card p-6 backdrop-blur-xl bg-white/70 border border-white/20 shadow-xl">
            ...
            <div className="space-y-6">
              <div className="grid gap-4 md:grid-cols-3">
                <Card className="p-4 bg-linear-to-br from-green-50 to-emerald-50 border border-green-200">
                ...
                <Card className="p-4 bg-linear-to-br from-blue-50 to-cyan-50 border border-blue-200">
                ...
                <Card className="p-4 bg-linear-to-br from-purple-50 to-pink-50 border border-purple-200">
