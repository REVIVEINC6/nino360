...
export function DocumentsManagementContent() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {/* AI Insights */}
      <Card className="backdrop-blur-sm bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-white/20 shadow-lg">
        <CardHeader>
          ...
          <Card className="backdrop-blur-sm bg-white/50 border-white/20 shadow-lg">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">Create Policy</Button>
              </div>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
