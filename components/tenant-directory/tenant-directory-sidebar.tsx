          ...
          <div className="p-4 space-y-6">
            ...
            <Card className="border-white/10 bg-white/5 backdrop-blur-xl">
              ...
              <CardContent className="space-y-2">
                <Button
                  variant="outline"
                  className="w-full justify-start border-white/10 bg-gradient-to-r from-[#4F46E5]/20 to-[#8B5CF6]/20 text-white hover:from-[#4F46E5]/30 hover:to-[#8B5CF6]/30"
                  size="sm"
                  ...
                  {recentTenants.map((tenant, index) => (
                    <div key={tenant.id}>
                      <div className="flex items-start gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[#4F46E5] to-[#8B5CF6]">
            ...
            {/* AI Insights */}
            <Card className="border-[#8B5CF6]/30 bg-gradient-to-br from-[#4F46E5]/10 to-[#8B5CF6]/10 backdrop-blur-xl">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium flex items-center gap-2 text-white">
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  ...
                  <div className="h-2 w-full rounded-full bg-white/10">
                    <div className="h-full w-3/4 rounded-full bg-gradient-to-r from-[#4F46E5] to-[#8B5CF6]" />
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="h-2 w-full rounded-full bg-white/10">
                    <div className="h-full w-2/3 rounded-full bg-gradient-to-r from-[#6D28D9] to-[#A855F7]" />
                  </div>
                </div>
