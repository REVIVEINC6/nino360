  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card className="glass-panel border-2 border-white/20 shadow-2xl">
        <CardHeader className="border-b border-white/10 bg-gradient-to-r from-blue-500/5 via-purple-500/5 to-pink-500/5">
        ...
        <CardContent className="p-8 space-y-6">
          ...
          <AnimatePresence>
            {aiPredictions && (
              ...
              >
                <Card className="border-2 border-blue-500/30 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-600 text-white border-0 hover:from-blue-600 hover:via-purple-700 hover:to-pink-700 shadow-lg px-8"
        >
          {isPending ? (
            <>
              <Loader2 className="mr-2 h-4 w-4 animate-spin" />
