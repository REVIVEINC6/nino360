  ...
  return (
    <div className="w-80 border-l bg-muted/30 p-4 space-y-4 overflow-auto">
      <ScrollArea className="h-full">
        {/* Overview Stats */}
        <Card className="p-4 space-y-3 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-200/50">
        ...
        {/* AI Insights */}
        <Card className="p-4 space-y-3 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border-blue-200/50">
          <div className="flex items-center gap-2">
        ...
        {/* SLA Alerts */}
        <Card className="p-4 space-y-3 bg-gradient-to-br from-amber-500/10 to-orange-500/10 border-amber-200/50">
          <div className="flex items-center gap-2">
