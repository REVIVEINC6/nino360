  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="p-6 bg-gradient-to-br from-blue-50/50 to-purple-50/50 border-blue-200/50 backdrop-blur-sm">
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-50/50 to-pink-50/50 border-purple-200/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
        ...
        <Card className="p-6 bg-gradient-to-br from-pink-50/50 to-orange-50/50 border-pink-200/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
        ...
        <Card className="p-6 bg-gradient-to-br from-orange-50/50 to-blue-50/50 border-orange-200/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="h-12 w-12 rounded-full bg-gradient-to-br from-orange-500 to-blue-500 flex items-center justify-center">
      ...
      <Card className="p-6 bg-white/50 backdrop-blur-sm border-gray-200/50">
        ...
        <div className="space-y-4">
          {consultants.map((consultant) => (
            <div
              key={consultant.id}
              className="flex items-center justify-between p-4 rounded-lg border bg-gradient-to-r from-gray-50/50 to-white/50 hover:shadow-md transition-shadow"
            >
