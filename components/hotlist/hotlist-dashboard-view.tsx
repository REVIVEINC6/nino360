      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="border-border/40 bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur">
            ...
            <Card className="border-border/40 bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
            ...
            <Card className="border-border/40 bg-gradient-to-br from-orange-500/10 to-red-500/10 backdrop-blur">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
