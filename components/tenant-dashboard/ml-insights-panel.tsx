      ...
      <Card className="glass border-white/20 bg-white/40 backdrop-blur-xl">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2 bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
          ...
          <div className="space-y-4">
            {insights.map((insight, index) => {
              ...
              return (
                <div
                  key={insight.id}
                  className="animate-fade-in group rounded-lg border border-white/20 bg-white/60 p-4 backdrop-blur-sm transition-all hover:border-indigo-300 hover:bg-white/80 hover:shadow-lg"
