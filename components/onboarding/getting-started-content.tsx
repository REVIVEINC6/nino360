    ...
    <div className="min-h-screen bg-linear-to-br from-background via-background to-muted/20 p-6">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold bg-linear-to-r from-primary via-purple-500 to-pink-500 bg-clip-text text-transparent">
            Welcome to Nino360! 🎉
          </h1>
        ...
        <Card className="p-6 bg-card/50 backdrop-blur-sm border-border/50">
          <div className="space-y-2">
            ...
            <div className="h-2 bg-muted rounded-full overflow-hidden">
              <div
                className="h-full bg-linear-to-r from-primary via-purple-500 to-pink-500 transition-all duration-500"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="p-2 rounded-lg bg-linear-to-br from-primary/10 to-purple-500/10 border border-primary/20">
        ...
        <div className="flex items-center justify-between pt-4">
          ...
          <Button
            ...
            className="bg-linear-to-r from-primary via-purple-500 to-pink-500"
          >
            Complete Setup
