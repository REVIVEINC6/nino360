...
export function OffersHeader({
  ...
  return (
    <div className="flex flex-col gap-4 p-6 bg-gradient-to-r from-indigo-600/10 via-purple-600/10 to-fuchsia-600/10 border-b border-white/10">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={onNewOffer} size="sm" className="bg-gradient-to-r from-indigo-600 to-purple-600">
