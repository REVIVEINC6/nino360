...
export function AnalyticsCards({ data }: AnalyticsCardsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card className="bg-linear-to-br from-indigo-500/10 to-purple-500/10 border-white/10">
      ...
      <Card className="bg-linear-to-br from-green-500/10 to-emerald-500/10 border-white/10">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
      ...
      <Card className="bg-linear-to-br from-blue-500/10 to-cyan-500/10 border-white/10">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
      ...
      <Card className="bg-linear-to-br from-amber-500/10 to-orange-500/10 border-white/10">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
