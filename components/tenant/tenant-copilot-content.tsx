  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-6 bg-linear-to-br from-blue-50 to-purple-50 border-blue-200">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-linear-to-br from-blue-500 to-purple-500 rounded-lg">
        ...
        <Card className="p-6 bg-linear-to-br from-pink-50 to-blue-50 border-pink-200">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-linear-to-br from-pink-500 to-blue-500 rounded-lg">
      ...
      <div className="flex justify-end">
        <Button onClick={handleSave} className="bg-linear-to-r from-blue-600 to-purple-600">
          Save Changes
        </Button>
      </div>
    </div>
