  ...
  return (
    <Tabs defaultValue="overview" className="space-y-6">
      ...
      <TabsContent value="overview" className="space-y-6">
        {/* Current Plan */}
        <Card className="p-6 bg-gradient-to-br from-blue-50/50 via-purple-50/50 to-pink-50/50 backdrop-blur-sm border-white/20">
      ...
      <TabsContent value="payment" className="space-y-6">
        <Card className="p-6 bg-white/50 backdrop-blur-sm border-white/20">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-gradient-to-br from-blue-50/50 to-purple-50/50 border border-white/20">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center">
                    <CreditCard className="h-6 w-6 text-white" />
                ...
                <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white border-0">Primary</Badge>
              </div>
            ...
            <Button className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white">
              Add Payment Method
            </Button>
          </div>
        </Card>
      ...
      <TabsContent value="usage" className="space-y-6">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          {/* Storage Usage */}
          <Card className="p-6 bg-gradient-to-br from-purple-50/50 via-pink-50/50 to-blue-50/50 backdrop-blur-sm border-white/20">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* API Calls Usage */}
          <Card className="p-6 bg-gradient-to-br from-pink-50/50 via-blue-50/50 to-purple-50/50 backdrop-blur-sm border-white/20">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-pink-500 to-blue-500 flex items-center justify-center">
        ...
        <Card className="p-4 bg-amber-50/50 backdrop-blur-sm border-amber-200/50">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <Button size="sm" className="mt-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white">
                Upgrade Plan
              </Button>
            </div>
          </div>
