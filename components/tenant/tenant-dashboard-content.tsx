  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 border-blue-200/50 backdrop-blur-sm">
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
        ...
        <Card className="p-6 bg-gradient-to-br from-pink-50 to-blue-50 border-pink-200/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-muted-foreground">Storage Used</p>
              <p className="text-3xl font-bold mt-2 bg-gradient-to-r from-pink-600 to-blue-600 bg-clip-text text-transparent">
        ...
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
          {quickActions.map((action) => (
            <Link key={action.href} href={action.href}>
              <Button
                variant="outline"
                className="w-full justify-start gap-2 h-auto py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 bg-transparent"
              >
