    ...
    <Tabs defaultValue="overview" className="space-y-6">
      ...
      <TabsContent value="overview" className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-4">
          <Card className="p-6 bg-linear-to-br from-blue-50 to-purple-50 border-white/20 backdrop-blur-sm">
          ...
          <Card className="p-6 bg-linear-to-br from-purple-50 to-pink-50 border-white/20 backdrop-blur-sm">
            <div className="flex items-center gap-4">
          ...
          <Card className="p-6 bg-linear-to-br from-pink-50 to-orange-50 border-white/20 backdrop-blur-sm">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-lg bg-linear-to-br from-pink-500 to-orange-500">
          ...
          <Card className="p-6 bg-linear-to-br from-orange-50 to-yellow-50 border-white/20 backdrop-blur-sm">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-lg bg-linear-to-br from-orange-500 to-yellow-500">
