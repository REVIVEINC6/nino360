...
export function TenantUsersContent({ users: initialUsers }: TenantUsersContentProps) {
  ...
  const getRoleBadgeColor = (role: string) => {
    switch (role) {
      case "admin":
        return "bg-linear-to-r from-purple-500/20 to-pink-500/20 text-purple-700 border-purple-300"
      case "manager":
        return "bg-linear-to-r from-blue-500/20 to-cyan-500/20 text-blue-700 border-blue-300"
      default:
        return "bg-linear-to-r from-gray-500/20 to-slate-500/20 text-gray-700 border-gray-300"
    }
  }
  ...
  const getStatusBadgeColor = (status: string) => {
    switch (status) {
      case "active":
        return "bg-linear-to-r from-green-500/20 to-emerald-500/20 text-green-700 border-green-300"
      case "inactive":
        return "bg-linear-to-r from-red-500/20 to-rose-500/20 text-red-700 border-red-300"
      default:
        return "bg-linear-to-r from-yellow-500/20 to-amber-500/20 text-yellow-700 border-yellow-300"
    }
  }
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-4 flex-1">
                <div className="h-12 w-12 rounded-full bg-linear-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold">
