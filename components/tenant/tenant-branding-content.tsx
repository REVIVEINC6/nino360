...
export function TenantBrandingContent() {
  ...
  const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      // uploadLogo expects a File. Call it directly with the File and handle the
      // returned shape { ok, url }.
      const resp: any = await uploadLogo(file)
      const url = resp?.url || ""
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="logo" className="space-y-6">
        <TabsList className="bg-white/50 backdrop-blur-sm border border-white/20">
          ...
          <TabsTrigger
            value="colors"
            className="data-[state=active]:bg-linear-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white"
          >
          ...
          <TabsTrigger
            value="typography"
            className="data-[state=active]:bg-linear-to-r data-[state=active]:from-pink-500 data-[state=active]:to-rose-500 data-[state=active]:text-white"
          >
          ...
          <TabsTrigger
            value="preview"
            className="data-[state=active]:bg-linear-to-r data-[state=active]:from-blue-500 data-[state=active]:to-pink-500 data-[state=active]:text-white"
          >
